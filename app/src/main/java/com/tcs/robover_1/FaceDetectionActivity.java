            ...
            Voicerecon(6000, VOICE_RECOGNITION_REQUEST_CODE);
                    ...
                    /*{
                        ...
                        if (hours >= 0 && hours <= 12) {
                            ...
                            String name = sd.getString("name", "bla");
                            if (name.equals("bla")) {
                                dontdistrb = true;

                                speakOut("Hellow, Good Morning .This is I Robo . I have just encoundered " + count + " of You .So what is your name?");
                                ...
                                speakOut("Hellow, Good Morning .Is it " + name + " there?");
                            ...
                            if (name.equals("bla")) {
                                dontdistrb = true;
                                speakOut("Hellow, Good Afternoon .This is I Robo . I have just encoundered " + count + " of You .So what is your name?");
                                ...
                                speakOut("Hellow, Good Afternoon .Is it " + name + " there?");
                            ...
                            if (name.equals("bla")) {
                                dontdistrb = true;
                                speakOut("Hellow, Good Evening .This is I Robo . I have just encoundered " + count + " of You .So what is your name?");
                            ...
                            dontdistrb = true;
                            speakOut("Hello,.This is I Robo . Its , late Night already . I have just encoundered " + count + " of You .So , What is your name?!!");
    ...
    private class DetectionTask extends AsyncTask<InputStream, String, com.microsoft.projectoxford.face.contract.Face[]> {
        ...
        protected com.microsoft.projectoxford.face.contract.Face[] doInBackground(InputStream... params) {
            ...
            FaceServiceClient faceServiceClient =
                    new FaceServiceClient("b9cbce78ec6e4ab893ca281e292d3c80");
            try {
        ...
        protected void onPreExecute() {
            ...
            if(waiting==false) {
                speakOut("Welcome to I Bot Automated Console  , Let me take the honour to introduce myself to you , I was developed in T C S Innovations Labs , I am a social robot with the capability to do anything ");
                waiting=true;
            }
             else
            {
        ...
        protected void onPostExecute(com.microsoft.projectoxford.face.contract.Face[] result) {
            if (mSucceed) {
                try {
                    ...
                    String Details = "Age: " + formatter.format(faces.get(0).attributes.age) + "\n"
                            + "Gender: " + faces.get(0).attributes.gender;
                    int count = 0;
                    int malecount = 0;
                    int femalecount = 0;

                    String genderwa = faces.get(0).attributes.gender.toString();
                    for (com.microsoft.projectoxford.face.contract.Face f : faces) {
                        if (f.attributes.gender.toString().equals("male")) {
                            malecount++;
                    ...
                    if (count == 2) {
                        ...
                        if (genderwa.equals("male")) {
                            gen=true;
                            speakOutadd("hello ,Sir. Would you like me to read some news for you ?");
                            new Handler().postDelayed(new Runnable() {
                            ...
                            gen=false;
                            speakOutadd("hello , Mam .Would you like to know about recent fashion trends or bollywood gossips ?");
                            new Handler().postDelayed(new Runnable() {
